...
const Experience = () => {
  ...
  const experienceJob = jobList.filter((job) => job.position === "experienced");
  return (
    <>
      <div id="experienceSection" className="mx-auto min-h-full py-20">
        <div>
          <motion.div
            initial="hidden"
            whileInView="visible"
        ...
        <div className="text-center mt-8">
          {experienceJob.length > 6 && !showAllJob && (
            <button
